...
// Unga image paths-a inga import pannikonga
// import quickPickupImg from './assets/quick-pickup.jpg';
// import bestFaresImg from './assets/best-fares.jpg';
// import neverTooFarImg from './assets/never-too-far.jpg';

const WhatWeOffer = () => {
  const offers = [
    {
      id: 1,
      image: "https://via.placeholder.com/400x300", // Unga image path-a mathavum
      title: "Quick Pickup",
